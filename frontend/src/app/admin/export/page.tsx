    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-4xl mx-auto">
      ...
      <Card className="border-none shadow-heavy bg-card">
        <CardHeader className="border-b border-border/50 pb-6">
          ...
          <CardDescription>
            Apply custom parameters to narrow down the target export file. Bypasses standard table pagination.
          </CardDescription>
        </CardHeader>
        <CardContent className="p-6 md:p-8 space-y-6">
          ...
          <div className="bg-muted/30 border border-border p-4 rounded-xl space-y-2 text-xs text-muted-foreground mt-4">
            <h4 className="font-heading font-bold text-steel dark:text-muted-foreground flex items-center gap-1.5">
            ...
            <ul className="list-disc pl-4 space-y-1">
              ...
              <li>Generated CSV reports are uploaded to secure raw cloud repository and auto-expire after **1 hour**.</li>
              <li>Closing this page during execution **will not abort** background file compilation.</li>
            </ul>
          </div>
          ...
          <div className="pt-4 border-t border-border/50 flex justify-end">
            ...
            >
              <Download className={cn("size-5 transition-transform duration-300", isExporting ? "animate-bounce" : "group-hover:translate-y-0.5")} />
              {isExporting ? "Compiling CSV in Background..." : `Compile and Export ${exportType === 'students' ? 'Students' : 'Applications'}`}
            </Button>
          </div>
        </CardContent>
      </Card>
