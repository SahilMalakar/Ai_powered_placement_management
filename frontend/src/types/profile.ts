...
export type StudentProfileData = {
    ...
    profile: {
        ...
        createdAt: string;
        updatedAt: string;
        socialLinks: z.infer<typeof socialLinkSchema>[];
        experiences: (z.infer<typeof experienceSchema> & { id: number; profileId: number })[];
        projects: (z.infer<typeof projectSchema> & { id: number; profileId: number })[];
        skills: (z.infer<typeof skillSchema> & { id: number; profileId: number })[];
        additionalDetails: (z.infer<typeof additionalDetailSchema> & { id: number; profileId: number })[];
    };
