...
router.use('/v1/students', socialLinkRouter);
router.use('/v1/students', projectRouter);
router.use('/v1/students', skillRouter);
router.use('/v1/students', additionalDetailRouter);
